	...
	<div class="container-fluid">
		...
		<div id="services" class="row">
			<div class="col-12 offset-0 | col-md-8 offset-md-2 | text-center">
				<h2 class="extra-bold fs-1 ac-1 mb-3">Septic Services for My Home</h2>
			</div>
			<!-- slider -->
		...
		<div id="wondering" class="row">
			<div class="col-12 offset-0 | col-md-8 offset-md-2 | text-center mb-3 pb-3">
				<h2 class="extra-bold fs-1 ac-1">Wondering how to pay for your septic project?</h2>
			</div>
			<!-- txt -->
			<div class="col-12 offset-0 | col-sm-10 offset-sm-1 | col-md-5 offset-md-1 | col-xl-4 offset-xl-1 | p-3">
				...
				<div class="d-flex flex-row justify-content-start align-items-center mt-3">
					<img class="my-2 me-2" src="~/assets/images/common/icon-home-add.svg" alt="Icon" style="width: 60px;">
					Add the amount you need to finance
				</div>
				<div class="d-flex flex-row justify-content-start align-items-center">
					<img class="my-2 me-2" src="~/assets/images/common/icon-home-select.svg" alt="Icon" style="width: 60px;">
					Select your credit score
				</div>
				<div class="d-flex flex-row justify-content-start align-items-center mb-3">
					<img class="my-2 me-2" src="~/assets/images/common/icon-home-credit.svg" alt="Icon" style="width: 60px;">
					Click “get financing options” button to fill out application
				</div>
				<h3 class="extra-bold my-3">Benefits of Hearth:</h3>
				<ul id="benfits-list">
